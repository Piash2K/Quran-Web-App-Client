...
export function SurahCard({ surah }: SurahCardProps) {
  return (
    <article className="premium-card panel group relative flex h-full flex-col justify-between overflow-hidden p-6 transition duration-300 hover:-translate-y-1">
